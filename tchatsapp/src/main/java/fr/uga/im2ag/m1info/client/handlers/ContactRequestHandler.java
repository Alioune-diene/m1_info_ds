...
import fr.uga.im2ag.m1info.client.event.types.ContactAddedEvent;
import fr.uga.im2ag.m1info.client.event.types.ContactRequestReceivedEvent;
import fr.uga.im2ag.m1info.client.event.types.ContactRequestResponseEvent;
import fr.uga.im2ag.m1info.client.model.ContactClient;
import fr.uga.im2ag.m1info.client.model.ContactRequest;
import fr.uga.im2ag.m1info.client.repository.ContactClientRepository;
import fr.uga.im2ag.m1info.common.MessageType;
import fr.uga.im2ag.m1info.common.messagefactory.ContactRequestMessage;
import fr.uga.im2ag.m1info.common.messagefactory.ContactRequestResponseMessage;
import fr.uga.im2ag.m1info.common.messagefactory.ProtocolMessage;

import java.time.Instant;

public class ContactRequestHandler extends ClientMessageHandler {
    @Override
